...
abstract class BaseActivity : AppCompatActivity(), View.OnClickListener {
    ...
    //请求失败弹窗
    internal var httperror_view:AlertView?=null;
...
//        EventBus.getDefault().unregister(mContext)
    ...
    */
    ...
    //接口错误
    open fun onError(what: Int,msg:String){
     ...
     * 获得加密后的参数
     */
    fun getSignStr (param:HashMap<String,String>) :String
    {
        var str=""
        for (item in param)
        {
        ...
        str+="&"+Constant.KEY
        Log.i("param",str);
        return MD5Utils.getPwd(str).toLowerCase()
    }
