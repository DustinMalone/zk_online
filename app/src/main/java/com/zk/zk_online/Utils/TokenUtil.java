 ...
 *
 * 得到sign信令 的key
 * Created by ZYB on 2017/11/18 0018.
 */

public class TokenUtil {

    public static String getToken(String APPID,String AppCertificate,String account)
    {
        long expiredTimeWrong = new Date().getTime()/1000 + 3600;
        long expiredTime = System.currentTimeMillis()/1000 + 3600;
        String token=calcToken(APPID, AppCertificate, account, expiredTime);
        return  token ;
    }
